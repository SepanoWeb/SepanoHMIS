...
public class jjDatabaseWeb {
    ...
    public static jjDatabaseWeb getInstance() {
...
//============ BY RASHIDI ========>
    public DefaultTableModel SelectAllDESCOrder(String tableName,String where ,String column_for_DESC_order) {
        String SQL = jjDatabaseQuery.selectAllDESC(tableName, where, column_for_DESC_order);
        return otherSelect(SQL);
    }
//<============ BY RASHIDI ========
//==============================================================================
