...
FarsiType.KeyObject = function(z,x) {
	...
	GenerateStr = "";
	if (FarsiType.ShowChangeLangButton == 1) {
		GenerateStr = GenerateStr + "<input type='button' id=FarsiType_button_"+x+" style=' font-size:11;     color: #99a0aa; font-family:tahoma; padding: 1px; margin: 1px; width: auto; height: auto;    border-radius: 80px;    width: 41px;' value='FA' />&nbsp;";
	}
	if (FarsiType.ChangeDir == 2) {
		GenerateStr = GenerateStr  + "<input type='button' id=FarsiType_ChangeDir_"+x+" style='bfont-size:11;     color: #99a0aa; font-family:tahoma; padding: 1px; margin: 1px; width: auto; height: auto;    border-radius: 80px;    width: 41px;' value='RTL' />"
	}
