        ...
        <div class="card bd-primary mg-t-20" >
            ...
            <div class="card-body pd-sm-30">
                <div id="" class="card bd-primary">
                    ...
                    <div class="row row-sm" id="sessionsArchivesForm">
                        <div class="col-lg-12">
                ...
                <div class="row row-sm">
                    <div class="col-lg-12">  
                        <div class="card-body pd-sm-30">
                            ...
                            <textarea rows="3" type='text' value='' class="form-control is-valid mg-t-20" ><%=sessionRow.get(0).get(Sessions._agenda)%>
                            </textarea> 
                            ...
                            <div class="card-body pd-sm-30">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea   rows="3" class="form-control is-valid mg-t-20"><%=sessionRow.get(0).get(Sessions._sessionDescription)%>
                                        </textarea>
                                    </div>
                                </div>
                ...
                <div class="col-lg-12">   
                    <button id='btnPrint'  class="btn btn-outline-success active btn-block mg-b-10" onclick="window.print();"> پرینت صورتجلسه
                    </button>
                </div>
            </div>
            <script>
