var cmsNews = {
    ...
    m_add_Ln: function (id, langId) {
        var param = "";
        param += "do=" + cmsNews.tableName + ".add_lang";
        param += "&" + cmsNews.f_id + "=" + (id == null ? "" : id);
        param += "&myLang=" + (langId == null ? "1" : langId);
        jj(param).jjAjax2(false);
        new jj("#" + cmsNews.f_parent).jjVal(id);
        new jj("#" + cmsNews.f_lang).jjVal(langId);
//        alert(id+"&&&&&"+langId);
        cmsNews.m_show_form();
    },
    //<============ BY RASHIDI ========
...
var cmsCategoryNews = {
    ...
    m_add_Ln: function (id, langId) {
        var param = "";
        param += "do=" + cmsCategoryNews.tableName + ".add_lang";
        param += "&" + cmsCategoryNews.f_id + "=" + (id == null ? "" : id);
        param += "&myLang=" + (langId == null ? "1" : langId);
        jj(param).jjAjax2(false);
        new jj("#" + cmsCategoryNews.f_parent).jjVal(id);
        new jj("#" + cmsCategoryNews.f_lang).jjVal(langId);
//        alert(id+"&&&&&"+langId);
        cmsCategoryNews.m_show_form();
    },
    //<============ BY RASHIDI ========
