...
//        <=================mirhaj-->
        cmsPortal.getProp1List(id);
        cmsPortal.getProp2List(id);
        cmsPortal.getProp3List(id);
        cmsPortal.getProp4List(id);
        cmsPortal.getProp5List(id);
//        =================>mirhaj-->
...
//    <=================mirhaj-->
     getProp1List: function (id) {
        var param = "";
        param += "do=" + cmsPortal.tableName + ".get_prop1List";
        param += "&panel=" + "portal_post_prop1";
        param += "&selected=" + (id == null ? "" : id);
        jj(param).jjAjax2(false);
    },
    getProp2List: function (id) {
        var param = "";
        param += "do=" + cmsPortal.tableName + ".get_prop2List";
        param += "&panel=" + "portal_post_prop2";
        param += "&selected=" + (id == null ? "" : id);
        jj(param).jjAjax2(false);
    },
    getProp3List: function (id) {
        var param = "";
        param += "do=" + cmsPortal.tableName + ".get_prop3List";
        param += "&panel=" + "portal_post_prop3";
        param += "&selected=" + (id == null ? "" : id);
        jj(param).jjAjax2(false);
    },
    getProp4List: function (id) {
        var param = "";
        param += "do=" + cmsPortal.tableName + ".get_prop4List";
        param += "&panel=" + "portal_post_prop4";
        param += "&selected=" + (id == null ? "" : id);
        jj(param).jjAjax2(false);
    },
    getProp5List: function (id) {
        var param = "";
        param += "do=" + cmsPortal.tableName + ".get_prop5List";
