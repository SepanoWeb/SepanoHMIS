...
//        new jj("#" + hmisPlansForAssess.f_title).jjVal("");
//        new jj("#" + hmisPlansForAssess.f_lang).jjVal("1");
//        new jj("#" + hmisPlansForAssess.f_parent).jjVal("0");
...
//        $("#Content_Language_button").hide();
    ...
    m_show_tbl: function () {
        ...
        if ($('#swPlansForAssessTbl').html() == "") {
            hmisPlansForAssess.m_refresh();
        }
//        hmisPlansForAssess.tabSizeTbl();
    },
    m_insert: function () {
...
//        param += "&panel=content_search_tags_result";
    ...
    //<============ BY RASHIDI ========    
    tabSizeTbl: function () {
        $('#swPlansForAssess').css('height', 520);
    },
    tabSizeForm: function () {
        $('#swPlansForAssess').css('height', 378);
    }
