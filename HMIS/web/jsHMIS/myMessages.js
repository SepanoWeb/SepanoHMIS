...
//                   alert(1);
                ...
                new jj('#sendMyMessage').jjAjaxFileUploadTitleUploadFiles('#MyMessageAttachFile', '#myMessages_attachFile', 'myMessages_titleFile', '#myMessages_attachFileTitle','.inputSelectorDiv');
...
//        cmsUser.m_getGroups();
    ...
    m_remove: function (idUpload, id) {
        new jj("آیا از حذف این رکورد اطمینان دارید؟").jjModal_Yes_No("پیام هشدار قبل از حذف", "hmisMyMessages.removeFile(" + idUpload + "," + id + ");");
    },
    removeFile: function (idUpload, id) {

        var param = "";
        param += "do=" + hmisMyMessages.tableName + ".removeFile";
...
//        $('#UserSelectOption').trigger('change');
    ...
    tabSizeTbl: function () {
        $('#swMyMessages').css('height', 515);
        hmisMyMessages.heightTab = 515;
    },
    tabSizeForm: function () {
        $('#swMyMessages').css('height', 270);
        hmisMyMessages.heightTab = 270;
    },
    heightTab: "515",
